...
// TENTATIVA DE FIX DE IMPORT:
// Se der erro de novo, verifique se o arquivo se chama exatamente TeamMemberFormModal.tsx
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[11px] font-black text-primary uppercase">{c.daily_capacity_hours}h / dia</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 pt-2 mt-auto border-t border-border/50">
              <Button
                size="sm"
                variant="ghost"
                className="rounded-xl flex-1 gap-2 text-[10px] font-black uppercase transition-colors h-10"
                onClick={() => {
                  setEditingMember(c);
                  setModalOpen(true);
                }}
              ...
              >
                {c.active ? (
                  <>
                    <ToggleRight className="h-5 w-5" /> Inativar
                  </>
                ) : (
                  <>
                    <ToggleLeft className="h-5 w-5" /> Ativar
                  </>
                )}
              </Button>
            </div>
