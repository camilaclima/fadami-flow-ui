...
export function RefinementForm({ item, onSaved, readOnly }: Props) {
  ...
  const PremiumTextArea = ({ label, value, onChange, placeholder }: { label: string; value: string; onChange: (v: string) => void; placeholder: string }) => (
  ...
  return (
    <div className="space-y-5">
      <PremiumTextArea label="Refinamento funcional" value={fr} onChange={setFr} placeholder="Descreva o refinamento funcional..." />
      <PremiumTextArea label="Refinamento técnico" value={tr} onChange={setTr} placeholder="Descreva o refinamento técnico..." />
      <PremiumTextArea label="Critérios de aceite" value={ac} onChange={setAc} placeholder="Liste os critérios de aceite..." />
      <PremiumTextArea label="Definição de pronto (DoD)" value={dod} onChange={setDod} placeholder="Defina quando estará pronto..." />
